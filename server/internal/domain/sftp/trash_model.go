...
type TrashDir struct {
	...
	UserID   uuid.UUID `gorm:"type:uuid;not null;index;uniqueIndex:idx_sftp_trash_dir_key" json:"user_id"`
	ServerID uuid.UUID `gorm:"type:uuid;not null;index;uniqueIndex:idx_sftp_trash_dir_key" json:"server_id"`
	Path     string    `gorm:"type:text;not null;uniqueIndex:idx_sftp_trash_dir_key" json:"path"`
